#!/usr/bin/env python3
"""Build Xinchang v3 from the WHO p.168 straight palmar hand."""
...
OUTPUT_PNG = HERE / "心常穴_正式評估版_v3_WHO-p168左手掌面.png"
OUTPUT_SVG = HERE / "心常穴_正式評估版_v3_WHO-p168左手掌面.svg"
OUTPUT_JSON = HERE / "心常穴_定位資料_v3.json"
